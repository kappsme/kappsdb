...
INSERT INTO `kapps_db`.`tx_params_cat` (`id`, `module_id`, `nombre`, `estado`, `html_type`, `category`, `customizable`, `required`, `system`, `default_value`) VALUES ('67', '2', 'Cliente Mandatorio en Registro de Venta', '1', 'CHECKBOX', 'PARAMETERS', '1', '1', '1', '1');
